...
describe('DocSlideshowValidator', () => {
    ...
    describe('validate', () => {
        ...
        it('should not pass if directive is applied to <img> tag', () => {
            ...
            expect(reporter).toHaveBeenCalledWith(`Property "undefined" of component "picture" uses "focuspoint" feature on <img> html tag, which is not supported, "focuspoint" can be applied to other html tags, whereimage is a background`);
        });
    });
});